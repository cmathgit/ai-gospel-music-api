...
def generate_mnemonic_song_verbatim_custom():
    ...
    yt_title_1 = f"INFO VERBATIM {topic_choice_fill_in} {song_genre_choice[0]} {timestamp_str} [{musical_key_choice[0]}] [{tempo_choice[0]}] [AILLM Music]\n\n"
    check_and_write_to_file('log/verbatim_info_prompt_history.txt', 'verbatim_info_prompt_history', yt_title_1)
    print(yt_title_1)
    print("")
        
    yt_title_2 = f"INFO VERBATIM {topic_choice_fill_in} {song_genre_choice[0]} {timestamp_plus_1_sec} [{musical_key_choice[0]}] [{tempo_choice[0]}] [AILLM Music]\n\n"
...
def mnemonic_concerto_song_verbatim_custom():
    ...
    yt_title_1 = f"INFO VERBATIM {topic_choice_fill_in} {concerto_variant_name} {timestamp_str} [{musical_key_choice[0]}] [{tempo_choice[0]}] [AILLM Music]\n\n"
    check_and_write_to_file('log/verbatim_info_prompt_history.txt', 'verbatim_info_prompt_history', yt_title_1)
    print(yt_title_1)
    print("")

    yt_title_2 = f"INFO VERBATIM {topic_choice_fill_in} {concerto_variant_name} {timestamp_plus_1_sec} [{musical_key_choice[0]}] [{tempo_choice[0]}] [AILLM Music]\n\n"
    check_and_write_to_file('log/verbatim_info_prompt_history.txt', 'verbatim_info_prompt_history', yt_title_2)
    print(yt_title_2)
    print("")
